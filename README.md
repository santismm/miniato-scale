...
Autor: Santiago Miniato Santa María Morales (Madrid). Estado: **propuesta metodológica v2.1, reglas `pilot-0.2`, sin validación empírica todavía.**
...
```
paper/      Preprint v2.1 en LaTeX (inglés, con resumen en español) y PDF compilado

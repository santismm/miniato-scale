...
\date{September 2026 \quad\textperiodcentered\quad Preprint, version 2.3 \quad\textperiodcentered\quad Rules version \texttt{pilot-0.2}}
...
\item \textbf{Consequences only.} The level classifies harm that has materialised up to a stated cut-off date. Potential harm is recorded as a \emph{hazard}.
...
\item \textbf{Honest uncertainty.} Missing evidence yields a set of admissible levels.

...
\date{September 2026 \quad\textperiodcentered\quad Preprint, version 2.5 \quad\textperiodcentered\quad Rules version \texttt{pilot-0.3}}
...
\item \textbf{Trends are counted, not averaged.} A mean of Miniato levels is not interpreted as mean severity, because the scale sets no equal intervals between categories. Seismic catalogues report counts of events per magnitude band \citep{gutenberg1944}; the Miniato bulletin adopts the counting practice, not the physical magnitude behind it.
\end{enumerate}
